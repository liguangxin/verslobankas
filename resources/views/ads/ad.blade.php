            ...
            <div class="flex-1 lg:mr-13px">
                <div class="relative mb-25px">
                    ...
                    <div class="flex justify-center py-10px lg:py-0 lg:absolute lg:left-0 lg:right-0 lg:mx-auto lg:-mt-70px">
                        <a data-fancybox="gallery" href="{{ asset('images/tmp/photo-1573090951351-f256de340dea.jpeg') }}" class="bg-cover bg-center w-59px lg:w-56px h-59px lg:h-56px border-2 border-blue-5 rounded-10px mr-17px lg:mr-12px" style="background-image: url({{ asset('images/tmp/photo-1573090951351-f256de340dea_thumb.jpeg') }})"></a>
                        <a data-fancybox="gallery" href="{{ asset('images/tmp/photo-1560879052-0cccc41ec8fb.jpeg') }}" class="bg-cover bg-center w-59px lg:w-56px h-59px lg:h-56px border-2 border-blue-5 rounded-10px mr-17px lg:mr-12px" style="background-image: url({{ asset('images/tmp/photo-1560879052-0cccc41ec8fb_thumb.jpeg') }})"></a>
                        <a data-fancybox="gallery" href="{{ asset('images/tmp/photo-1568392388563-e7b357fa41d8.jpeg') }}" class="bg-cover bg-center w-59px lg:w-56px h-59px lg:h-56px border-2 border-blue-5 rounded-10px mr-17px lg:mr-12px" style="background-image: url({{ asset('images/tmp/photo-1568392388563-e7b357fa41d8_thumb.jpeg') }})"></a>
                        <a href="javascript:" id="ad_more_photos" class="flex items-center justify-center w-59px lg:w-56px h-59px lg:h-56px border-white rounded-10px bg-blue-11 border-2 border-blue-5">
