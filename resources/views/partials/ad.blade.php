<div class="vbad {{ ($promoted ? 'vbad-promoted' : '') }} flex flex-col lg:flex-row rounded-lg p-12px mb-2 relative">
    <div class="absolute top-0 right-0 flex items-center text-12px font-light text-blue-1 mt-3 mr-4">
        <span class="mr-2">Įsiminti skelbimą</span>
    ...
    <div>
        <div class="flex items-center">
            <a href="javascript:"><h3 class="vbad-title text-14px lg:text-16px leading-tight lg:leading-normal mt-3 lg:mt-0 mr-2">Parduodu transporto įmonę</h3></a>
            <a href="#" class="mx-2">
        ...
        <div class="flex items-center justify-between border-t border-blue-10 pt-12px">
            <div class="hidden lg:flex items-center text-13px font-light">
                <div class="bg-blue-2 rounded px-2 py-1 mr-24px">Internetinis verslas</div>
            ...
            <div class="font-semibold">8,000 EUR</div>
        </div>
    </div>
</div>
