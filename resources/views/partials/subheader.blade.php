<div class="subheading py-24px bg-blue-2">
    <div class="container">
        <div class="flex flex-wrap lg:flex-no-wrap justify-between">
            <button class="hidden lg:flex items-center justify-between text-12px uppercase text-white bg-blue-3 font-semibold px-21px py-15px rounded-custom-1 border-0">
            ...
            <div class="lg:flex-1 w-4/5 lg:pl-4">
            ...
            <div class="w-1/5 lg:w-auto flex justify-end">
                <button type="button" class="relative w-48px h-48px rounded-full flex items-center justify-center bg-white">
                    <span class="absolute top-0 right-0 bg-green-1 w-16px h-16px rounded-full text-white text-12px flex items-center justify-center">2</span>
